...
💡 Use np.all() to check whether all values are greater than or equal to 0.
...
array([ 80.,  90., 108.])
🔹 Implementation Flow:
💡 Use np.where() to check readings greater than or equal to 100.
...
💡 Hidden test focus: value exactly 100 should also be reduced to 90.
